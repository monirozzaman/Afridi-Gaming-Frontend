...
public class PalyedGameListAdapter extends ArrayAdapter<String> {
    ...
    public PalyedGameListAdapter(Activity context, String[] maintitle, String[] subtitle, Integer[] imgid) {
        super(context, R.layout.custom_pay_games_list_items, maintitle);
